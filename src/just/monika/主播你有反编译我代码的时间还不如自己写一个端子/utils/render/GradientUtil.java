...
public class GradientUtil implements Utils {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("DokiClient/Shaders/gradientMask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("DokiClient/Shaders/gradient.frag");
