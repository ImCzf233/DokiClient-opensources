...
public class SessionStats extends Module {
    ...
    private final Dragging dragging = DokiClient.INSTANCE.createDrag(this, "sessionstats", 40, 100);


    private final BooleanSetting animatedPlaytime = new BooleanSetting("Animated counter", true);
    public final ModeSetting colorMode = new ModeSetting("Color", "Sync", "Sync", "Analogous", "DokiClient", "Gradient", "Modern");
    public final ModeSetting degree = new ModeSetting("Degree", "30", "30", "-30");
    private final ColorSetting color1 = new ColorSetting("Color 1", DokiClient.INSTANCE.getClientColor());
    private final ColorSetting color2 = new ColorSetting("Color 2", DokiClient.INSTANCE.getAlternateClientColor());
    ...
    private final EventListener<Render2DEvent> eventCall = e -> {
        ...
        switch (colorMode.getMode()) {
            case "Sync":
                HudMod hudMod = (HudMod) DokiClient.INSTANCE.getModuleCollection().get(HudMod.class);
                ...
                break;
            case "DokiClient":
                gradientColor1 = ColorUtil.interpolateColorsBackAndForth(15, 0, DokiClient.INSTANCE.getClientColor(), DokiClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                gradientColor2 = ColorUtil.interpolateColorsBackAndForth(15, 90, DokiClient.INSTANCE.getClientColor(), DokiClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                gradientColor3 = ColorUtil.interpolateColorsBackAndForth(15, 180, DokiClient.INSTANCE.getClientColor(), DokiClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                gradientColor4 = ColorUtil.interpolateColorsBackAndForth(15, 270, DokiClient.INSTANCE.getClientColor(), DokiClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                break;
            case "Gradient":
