...
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.utils.render.ESPUtil;
...
public class GlowESP extends Module {
    ...
    private final ColorSetting glowColor = new ColorSetting("Glow Color", DokiClient.INSTANCE.getClientColor());
    ...
    private final ShaderUtil outlineShader = new ShaderUtil("DokiClient/Shaders/outline.frag");
    private final ShaderUtil glowShader = new ShaderUtil("DokiClient/Shaders/glow.frag");
