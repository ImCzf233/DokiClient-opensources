...
public class TenacityMainMenu extends GuiScreen {
    ...
    private final List<MenuButton> buttons = new ArrayList() {{
        add(new MenuButton("DokiClient/MainMenu/button1.png", "Singleplayer"));
        add(new MenuButton("DokiClient/MainMenu/button2.png", "Multiplayer"));
        add(new MenuButton("DokiClient/MainMenu/button3.png", "Alt Manager"));
    }};
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
            ...
            button.clickAction = () -> {
                switch (button.text) {
                    ...
                    case "Multiplayer":
                        ...
                        break;
                    case "Alt Manager":
                        mc.displayGuiScreen(DokiClient.INSTANCE.getAltManager());
                        break;
                }
            };
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("DokiClient/MainMenu/triplebars.png"));
