package just.monika.主播你有反编译我代码的时间还不如自己写一个端子.ui.altmanager.panels;
...
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.ui.altmanager.panels.components.Component;
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.ui.altmanager.panels.components.impl.AltRect;
...
public class AltListAltPanel implements AltPanel {
    ...
    ArrayList<just.monika.主播你有反编译我代码的时间还不如自己写一个端子.ui.altmanager.panels.components.Component> altObjects = new ArrayList<>();
