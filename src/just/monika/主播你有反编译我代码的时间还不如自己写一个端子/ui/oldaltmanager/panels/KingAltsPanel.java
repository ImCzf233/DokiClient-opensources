...
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.ui.oldaltmanager.backend.KingGenApi;
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.ui.oldaltmanager.panels.components.impl.StringField;
...
public class KingAltsPanel implements AltPanel {
    private final KingGenApi kingGenApi = null;//= DokiClient.INSTANCE.kingGenApi;
