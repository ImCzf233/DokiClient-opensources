...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        DokiClient.INSTANCE.getNotificationManager().drawNotifications(scaledresolution);
        ...
        if (scoreobjective1 != null && DokiClient.INSTANCE.isToggled(ScoreboardMod.class))
        {
