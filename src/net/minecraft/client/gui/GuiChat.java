...
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.module.impl.render.ArraylistMod;
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.module.impl.render.HudMod;
import just.monika.主播你有反编译我代码的时间还不如自己写一个端子.module.impl.render.SpotifyMod;
...
public class GuiChat extends GuiScreen {
    ...
    SpotifyMod spotifyMod = (SpotifyMod) DokiClient.INSTANCE.getModuleCollection().get(SpotifyMod.class);
    ...
    ArraylistMod arraylistMod = (ArraylistMod) DokiClient.INSTANCE.getModuleCollection().get(ArraylistMod.class);
